...
import { BottomLeftNotice } from "@/routes/-components/BottomLeftNotice";
import { PlusIcon } from "@/routes/-components/PlusIcon";
import { affixInset } from "@/routes/-lib/affix";
import type { BoardSection } from "@/routes/-lib/board";
import { publishBoardActions } from "@/routes/-lib/board-actions";
import { keepEditorFocus } from "@/routes/-lib/keep-editor-focus";
import { publishViewToggle, setViewMode, useViewMode } from "@/routes/-lib/view-mode";
