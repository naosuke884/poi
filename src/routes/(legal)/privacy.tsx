...
function Privacy() {
  return (
    <LegalPage title="プライバシーポリシー" updatedAt="2026 年 9 月 19 日">
      <p>
      ...
      <p>
        ...
        上に保存されます。 サーバーは日本国外に所在することがあります。
      </p>
      <ul>
        <li>
          板に書き込んだ内容は、各セクションが最初に書かれてから、利用者が設定した保存期間
          (初期設定では 30 日) が経過した時点で有効期限を迎え、期限を過ぎたものは
      ...
      <h2>9. 問い合わせ先</h2>
      <p>
        本ポリシーに関する問い合わせ、および個人情報の開示・削除の請求は、GitHub の Issue
        から受け付けています。
      </p>
      <p>
        <ContactLink />
      ...
      <p>
        ...
        「削除を希望する」旨だけを記載してください。本人確認の方法は運営者から Issue
        上で案内します。
      </p>
    </LegalPage>
  );
