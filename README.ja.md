...
- **セクションごとに 30 日で強制削除される** — 30 日経ったメモはすでに役目を終えているはず。また必要になったら、そのとき書き直せばよい
- **Markdown で構造化できる** — メモ書きといえども、見やすく構造化したくなることは少なくない
- **セクションごとのコピーとスクショ機能** — メモの共有がワンクリックで済む
- **セクションごとの折りたたみ・ワンクリック削除** — 関心を失ったメモはすぐに視界から消せる。完全に消すのもワンクリック
- **PWA** — ネイティブアプリのようにインストールでき、オフラインでも前回の板を読める
